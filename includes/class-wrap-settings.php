...
class WrapSettings {
    ...
    public static function add_admin_menu() {
        ...
        add_menu_page(__('WRAP', 'magiiic-wrap'), 'WRAP', 'manage_options', 'wrap', [self::class, 'options_page'], 'dashicons-admin-generic', $position);
    ...
    public static function settings_init() {
        ...
        add_settings_field(
            ...
            [self::class, 'menu_position_render'],
            'wrap_settings',
            'wrap_settings_section'
        );
    ...
    private static function url_exists($url) {
        ...
        return in_array($http_code, [200, 301, 302, 401, 403]);
    }
